...
//   // States for listing and adding properties
...
//     try {
//       // Fetch the property (and children) from our new endpoint
//       const response = await axios.get(
//         `${API_URL}property/with-children/${prop.id}`
//       );
//       // Set that as the selectedProperty
...
//                 {/* The add form for child properties remains in a table layout */}
...
// /* 
//   PropertyDetailModal:
//   - Initially shows property details (in a card view).
//   - Displays two main buttons: "Edit" and "Child Properties".
//     • "Edit" toggles edit mode for property details.
//     • "Child Properties" switches the view to show child properties in a card layout.
//   - In the child properties view, a "Back" button returns to the property view, 
//     and an "Edit Child Properties" button toggles editing mode.
//   - In both views, when not in edit mode, the data is displayed as plain text (cards).
// */
// function PropertyDetailModal({ property, onClose, refreshProperties }) {
...
//     try {
//       // You need a PUT route for updating property
//       await axios.put(`${API_URL}property/${localProperty.id}`, localProperty);
...
//     try {
//       // You need a PUT route for updating child properties
//       await axios.put(
//         `${API_URL}property/${localProperty.id}/child_properties`,
...
//   // --- Render the property details view ---
...
//   // --- Render the child properties view (as cards) ---

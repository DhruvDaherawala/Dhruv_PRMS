...
/**
 * NOTE: On Vercel, the file system is read-only at runtime.
 * Serving a local "uploads" folder won't work for dynamic uploads.
 * You can comment this out or remove it if it's not needed.
 * 
 * app.use("/uploads", express.static(path.join(__dirname, "uploads")));
 */
